...
fig.savefig('./RNN Paper Results/Exp1_2/Desert_Rock/2hour_Figure 2.jpg', bbox_inches = 'tight')
...
plt.savefig('./RNN Paper Results/Exp1_2/Desert_Rock/2hour_Figure 3', bbox_inches='tight')
...
df_trainLoss.to_csv('./RNN Paper Results/Exp1_2/Desert_Rock/2hour_DesertRock_TrainLoss.csv')
df_testLoss = pd.DataFrame(data={'Test Loss':test_loss,'iteration':test_iter}, columns=['Test Loss','iteration'])
df_testLoss.to_csv('./RNN Paper Results/Exp1_2/Desert_Rock/2hour_DesertRock_TestLoss.csv')
